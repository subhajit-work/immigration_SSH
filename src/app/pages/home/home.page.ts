...
export class HomePage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.meta.addTags([
      { name: 'title', content: 'Best Immigration Consultants in Brampton, Ontario, Mississauga, Toronto Canada' },
      { name: 'keywords', content: 'professional immigration consultants of canada, best immigration consultants in brampton, best immigration consultants in ontario, best immigration consultants in canada, best immigration consultants in mississauga,' },
      { name: 'description', content: 'Golden Venture is the Best Immigration Consultant in Brampton, Ontario, Mississauga, Toronto and Canada, and specializes in Immigration, Visa advice & procedures.' },
    ]);

    this._document.getElementById('pageTitle').innerHTML = 'Best Immigration Consultants in Brampton, Ontario, Mississauga, Toronto Canada';
  }
  ...
  getWhoWeAre(){
    this.getWhoWeAreSubscribe = this.http.get(this.getWhoWeAre_api).subscribe(
      ...
      this.getWhoWeAreBGimg = this.file_url+'/'+this.get_who_we_are.data.Path+'/'+this.get_who_we_are.data.image
    },
    errRes => {
    }
    );
