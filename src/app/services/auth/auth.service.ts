...
export class AuthService {
  ...
  private _globalparamsData2 = new BehaviorSubject(null);

  // get token session master as observable
  get globalparamsData(){
    // return this._globalparamsData2.asObservable();
  ...
  public getTokenSessionMaster() {
    ...
    this._globalparamsData = JSON.parse(sessionStorage.getItem("setStroageGlobalParamsData"));

    return this._globalparamsData;
  ...
  autoLoginWebsite(){
    ...
    var userdata = JSON.parse(sessionStorage.getItem("setStroageGlobalParamsData"));
    this._globalparamsData= userdata;
    return userdata;
  }
  ...
  // ================= login service call start ==================
    ...
    private storeAuthData(_data) {
      ...
      sessionStorage.setItem("setStroageGlobalParamsData", JSON.stringify(data))
  ...
  //======================= logout functionlity start ==============
    logout() {
      ...
      // });
      sessionStorage.removeItem("setStroageGlobalParamsData");
      // this._globalparamsData = null;
      window.location.reload();
    }
